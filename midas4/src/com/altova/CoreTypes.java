...
public class CoreTypes
{
	...
	public static String castToString(double d)
	{
		...
		//		"0.##########E0" : "0.##########", decfmtsymb);
		DecimalFormat decfmt = new DecimalFormat("0.##############", decfmtsymb);
		return decfmt.format(d);
		// Note: Double.toString(d) switches from 0.# to 0.#E0 format if dAbs is outside the range 10^-3 to 10^7. 
	}
	...
	public static boolean castToBool(String s)
	{
		if (s == null)
			return false;
		if (s.length() == 0 || s.equals("false") || s.equals("0"))
			return false;
		return true;
	}
