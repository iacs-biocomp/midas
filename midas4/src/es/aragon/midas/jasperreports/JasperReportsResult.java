...
package es.aragon.midas.jasperreports;
...
import es.aragon.midas.action.MidasJasperAction;
...
public class JasperReportsResult extends StrutsResultSupport implements JasperReportConstants {
	...
	protected void doExecute(String finalLocation, ActionInvocation invocation) throws Exception {
        ...
        String systemId = stack.findString("fullPath");
        Map<Object, Object> parameters = new ValueStackShadowMap(stack);
        File directory = new File(systemId.substring(0, systemId.lastIndexOf("/")));
        ...
        Map<Object, Object> reportParams = (Map<Object, Object>) stack.findValue(reportParameters);
        ...
        if (StringUtils.isEmpty(format)) {
            format = stack.findString("format");
        } 
        ...
        try {
            if (jndiDataSource != null)
            	conn = getJNDIConnection(jndiDataSource);
            if (conn == null)
            	conn = (Connection) ((MidasJasperAction)invocation.getAction()).getConnection();
            if (conn == null)
...
*/
            ...
            Map<Object, Object> exportParams = (Map<Object, Object>) stack.findValue(exportParameters);
        ...
        if (jndiDataSource == null && conn != null)
        	((MidasJasperAction)invocation.getAction()).closeConnection(conn);
    ...
    private void initializeProperties(ActionInvocation invocation) throws Exception {
        /*if (dataSource == null && connection == null && jndiDataSource == null) {
     ...
     * @return
     */
    Connection getJNDIConnection(String dataSourceName){
