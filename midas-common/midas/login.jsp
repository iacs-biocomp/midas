...
<div class="login-container">
	...
	<div class="login-content">
		<h2><strong>Bienvenido</strong>, por favor, identif�cate</h2>
		<s:form action="login" id="formLogin" namespace="/">
			...
			<div class="form-group">
				 <div class="checkbox checkbox-replace">
					...
					<label for="remeber">Recu�rdame</label>
				  </div>
			 </div> 
			 -->
			...
			<!--	// Recover password 
				<p class="text-center"><a href="forgot-password.html">�Olvidaste tu contrase�a?</a></p> 
			-->
				<!-- // new application  -->
