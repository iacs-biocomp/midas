...
public class Constants {
	...
	final public static String CFG_JPAPU = "midas.persistence.unit";
    ...
    final public static String CFG_AUTHENTICATE = "midas.authenticate";
	...
	final public static String FORBIDDEN = "forbidden";
