...
public abstract class CalendarBase 
{
  ...
  protected static final int DateTimePart_Year = 1 << 0;
  protected static final int DateTimePart_Month = 1 << 1;
  protected static final int DateTimePart_Day = 1 << 2;
  protected static final int DateTimePart_Date = DateTimePart_Year | DateTimePart_Month | DateTimePart_Day;
  protected static final int DateTimePart_Time = 1 << 3;
  ...
  protected void parseDate(String newvalue)
  {
  ...
  protected void parseTime(String newvalue)
  {
